module.exports = class Data1668525275491 {
  name = 'Data1668525275491'

  async up(db) {
    await db.query(`CREATE TABLE "liquidation_event" ("id" character varying NOT NULL, "collateral_asset" text NOT NULL, "debt_asset" text NOT NULL, "user" text NOT NULL, "debt_to_cover" numeric NOT NULL, "liquidated_collateral_amount" numeric NOT NULL, "liquidator" text NOT NULL, "receive_a_token" boolean NOT NULL, "block" numeric NOT NULL, "hash" text NOT NULL, CONSTRAINT "PK_b81c20a3c0b565ceaf4491d66c9" PRIMARY KEY ("id"))`)
